...
h-40 rounded-xl flex flex-col justify-center px-8 text-white shadow"
      ...
      <div className="bg-white p-6 rounded-xl shadow">
        ...
        <div className="flex items-center justify-between">
          <div>
            <p className="font-medium">React Avanzado</p>

            <p className="text-sm text-gray-500">Hoy - 7:00 PM</p>
      ...
      <div className="bg-white p-6 rounded-xl shadow">
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
          <GraficoProgreso nombre="React Avanzado" progreso={70} />

          <GraficoProgreso nombre="Node.js Backend" progreso={40} />

          <GraficoProgreso nombre="Bases de Datos" progreso={85} />
        </div>
      </div>
      ...
      <div className="bg-white p-6 rounded-xl shadow">
        ...
        <p className="font-medium">JavaScript Profesional</p>

        <p className="text-sm text-gray-500">Emitido el 20 de Marzo</p>
