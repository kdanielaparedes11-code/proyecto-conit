          ...
          <div className="border-b border-slate-200 px-6 py-5">
            <div className="flex flex-col gap-4 xl:flex-row xl:items-center xl:justify-between">
              ...
              <div className="flex flex-col gap-3 md:flex-row md:items-stretch">
                <div className="min-w-[250px] rounded-2xl border border-blue-200 bg-blue-50 p-4">
                  <div className="text-sm font-semibold text-blue-800">Descargar reporte</div>
                  <p className="mt-1 text-xs text-blue-700">
                    Exporta el listado visible según el filtro actual en formato PDF.
                  </p>
                ...
                <div className="min-w-[260px] rounded-2xl border border-slate-200 bg-slate-50 p-4">
                  ...
                  <input
                    ...
                    className="w-full rounded-xl border border-slate-300 bg-white px-3 py-2 text-slate-700 outline-none focus:border-slate-500 focus:ring-2 focus:ring-slate-200"
                  />
                </div>
